    ...
    <div className={s.page}>
      ...
      <div className={s.formSide}>
        <div className={s.card}>
          ...
          <p className={s.sub}>Commence à tracker tes sessions dès aujourd'hui</p>
          ...
          <form onSubmit={handleSubmit} className={s.form}>
            <div className={s.field}>
              ...
              <input type="text" value={name} onChange={e => setName(e.target.value)} placeholder="Ton prénom" required />
            </div>
            <div className={s.field}>
          ...
          <p className={s.switch}>Déjà un compte ? <Link to="/login" className={s.link}>Se connecter</Link></p>
        </div>
      </div>
